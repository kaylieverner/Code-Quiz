document.addEventListener("DOMContentLoaded", function () {
    ...
    // Display first question upon clicking start quiz button 
        ...
        function showQuestions() {
            ...
            button1.classList.add("btn", "btn-info", "m-3", "answerButton");
            button2.classList.add("btn", "btn-info", "m-3", "answerButton");
            button3.classList.add("btn", "btn-info", "m-3", "answerButton");
            button4.classList.add("btn", "btn-info", "m-3", "answerButton");
